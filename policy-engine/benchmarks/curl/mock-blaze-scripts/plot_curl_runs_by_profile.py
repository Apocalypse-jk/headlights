...
Usage:
    python policy-engine/benchmarks/curl/mock-blaze-scripts/plot_curl_runs_by_profile.py
    python policy-engine/benchmarks/curl/mock-blaze-scripts/plot_curl_runs_by_profile.py --succeeded-only
"""
...
def default_out_dir() -> Path:
    return Path(__file__).resolve().parent.parent / "plots" / "mock-blaze" / "runs_by_profile"
