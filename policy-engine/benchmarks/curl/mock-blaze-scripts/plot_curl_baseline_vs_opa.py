...
Usage:
    python policy-engine/benchmarks/curl/mock-blaze-scripts/plot_curl_baseline_vs_opa.py
    python policy-engine/benchmarks/curl/mock-blaze-scripts/plot_curl_baseline_vs_opa.py --succeeded-only
"""
...
def default_out_dir() -> Path:
    return Path(__file__).resolve().parent.parent / "plots" / "mock-blaze" / "architecture_comparison"
