...
Expected layout examples:
    ...
    runs/blaze/baseline/run_01/<measurement-name>/measurements.csv
    runs/blaze/opa/run_02/<measurement-name>/measurements.csv
...
Usage:
    python policy-engine/benchmarks/curl/blaze-scripts/plot_curl_histograms_by_run.py
    python policy-engine/benchmarks/curl/blaze-scripts/plot_curl_histograms_by_run.py --succeeded-only
"""
...
def default_out_dir() -> Path:
    return Path(__file__).resolve().parent.parent / "plots" / "blaze" / "histograms_by_run"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default="2",
        help=(
            "Histogram bin width in seconds. Default: 2, which starts at 0s "
            "and creates one new bar every 2s. Use a matplotlib mode like "
